export default function Shared() {
   return (
      <form className="fixed top-0 left-0 z-40 h-screen max-w-3xl p-4 overflow-y-auto block bg-white">
         <h5 class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">New Product</h5>
